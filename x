...
Definitions for 'anbeten':
	...
	Meanings:
	1. worship
No definitions available for 'beistehen'.
No definitions available for 'durchleben'.
Definitions for 'überlegen':
	Term:  überlegen [adj]
	Meanings:
	1. superior
	2. preponderant
...
Definitions for 'bemühen':
	...
	8. to make efforts
	9. to struggle
Definitions for 'sich verfahren':
	Term:  verfahren [adj]
	Meanings:
	1. stalled
	Term:  verfahren [verb]
	...
	1. oneself
		Expressions:
		1. Man sollte sich diese Frage stellen. [One should ask oneself this question.]
	2. himself
		Expressions:
		1. Er stellte sich vor. [He introduced himself.]
	3. herself
		Expressions:
		1. Sie stellte sich vor. [She introduced herself.]
	4. themselves
		Expressions:
		1. Sie stellen sich vor. [They introduced themselves.]
Definitions for 'sich verpflichten':
	Term:  verpflichten [verb]
	Meanings:
	1. to oblige
		Expressions:
		1. verpflichten die Mitgliedstaaten [to oblige the member states]
		2. verpflichten die Mitgliedstaaten per se [to per se oblige Member States]
	2. to require
		Expressions:
		1. gesetzlich verpflichtet [required by law]
		2. verpflichten die Kommission [to require the Commission]
	3. to commit
	4. to undertake
	5. to bound
	6. to force
