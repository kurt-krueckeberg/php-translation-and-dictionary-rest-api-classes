...
All  the interface and classes are in the `LanguageTools` namespace.
...
- abstract class `TranslatorWithDictionary` implements both `TranslateInterface` and `DictionaryInterface` and extends 
