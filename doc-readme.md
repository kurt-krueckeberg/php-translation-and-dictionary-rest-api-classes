...
Its free RESTful [sentences-service](http://api.corpora.uni-leipzig.de/ws/swagger-ui.html) API will return a specified number of example sentences for a given German word. There
